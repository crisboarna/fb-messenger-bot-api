 ...
 * exposed to users to create own object of proper shape if desired taking into account content restrictions for the
 * object.
 *
...
/**
 * Represents an Airline Boarding Pass Template secondary field. Used to represent shape of Facebook API object. Type
 * returned by builder and exposed to users to create own object of proper shape if desired taking into account content
 * restrictions for the object.
 *
 * Check link for content restrictions:
...
/**
 * Represents an Airline * Template arrival airport field. Used to represent shape of Facebook API object. Type returned
 * by builder and exposed to users to create own object of proper shape if desired taking into account content
 * restrictions for the object.
 *
 * Check link for content restrictions:
...
/**
 * Represents an Airline Itinerary Template passenger info field. Used to represent shape of Facebook API object.
 * Type returned by builder and exposed to users to create own object of proper shape if desired taking into account
 * content restrictions for the object.
 *
 * Check link for content restrictions:
...
/**
 * Represents an Airline Itinerary Template passenger segment field. Used to represent shape of Facebook API object.
 * Type returned by builder and exposed to users to create own object of proper shape if desired taking into account
 * content restrictions for the object.
 *
 * Check link for content restrictions:
