import {GenericTemplateBuilder} from "../../src/builders/templates/GenericTemplateBuilder";
...
describe('Client', () => {
    ...
    describe('getUserProfile', () => {
        const correctPayload = {
            ...
            url: `https://graph.facebook.com/v3.0/${TEST_ID}`
        };
    ...
    describe('sendImageMessage', () => {
        ...
        it('returns promise given no cb, no url and generates correct payload', () => {
            ...
            expect(result.constructor).toEqual(Promise);
            expect(mockRequest).toBeCalled();
            expect(mockRequest.mock.calls[0][0]).toEqual(correctPayloadId);
        });
        ...
        it('returns promise given no cb, url and generates correct payload', () => {
            ...
            expect(result.constructor).toEqual(Promise);
            expect(mockRequest).toBeCalled();
            expect(mockRequest.mock.calls[0][0]).toEqual(correctPayloadUrl);
        });
